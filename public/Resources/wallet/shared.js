...
var show_adv = false;
var adv_rule;
var symbol_btc = {code : "LTC", symbol : "LTC", name : "Litecoin",  conversion : satoshi, symbolAppearsAfter : true, local : false}; //Default LTC Currency Symbol object
...
function loadScript(src, success, error) {
    ...
    src = resource + src + (min ? '.min.js' : '.js');
